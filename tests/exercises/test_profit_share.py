...
from src.exercises.profit_share import calc_profit_share, Employee


class ProfitShareTest(unittest.TestCase):
    def test_scientist_normal(self):
        normal_scientist = Employee("Garry", 3)
    ...
    def test_scientist_advanced(self):
        normal_scientist = Employee("Garry", 10)
    ...
    def test_developer_advanced(self):
        advanced_developer = Employee("Garry", 8)
    ...
    def test_developer_expert(self):
        expert_developer = Employee("Garry", 11)
    ...
    def test_developer_normal(self):
        normal_developer = Employee("Garry", 3)
